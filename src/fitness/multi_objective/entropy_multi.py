...
class entropy_multi(base_ff):
    ...
    def __init__(self):
        ...
        self.num_obj = 2
        dummyfit1 = bit_entropy()
        dummyfit2 = hamming_distance()
        dummyfit1.maximise = True
        dummyfit2.maximise = True
        self.fitness_functions = [dummyfit1, dummyfit2]
